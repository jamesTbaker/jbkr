 ...
 * Object keys.
 */
export declare type TypeSizeKey = '3xs' | '2xs' | '1xs' | 's' | 'm' | 'l' | '1xl' | '2xl' | '3xl' | '4xl' | '5xl';
export declare type TypeWeightKey = 'regular' | 'bold';
export declare type TypeLineHeightKey = 'display' | 'body';
export declare type TypeSlantKey = 'normal' | 'italic';
/**
 * Subsets.
 */
