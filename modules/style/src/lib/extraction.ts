...
/**
 * Get Figma data using {@link fetchFigmaStylePages} and write it to the
 * local file system.
 *
 * @remarks
 * File write location is set in {@link definition}.
 *
 ...
 *
 * @remarks
 * File read location is set in {@link definition}.
 *
 * @returns An array of Figma page objects, or an `Error`.
 *
 * @internal
