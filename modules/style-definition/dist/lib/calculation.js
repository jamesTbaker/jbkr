    ...
    returnStoredFigmaStylePages()
        ...
        styleObjects.forEach((styleObject) => {
            ...
            if (propertiesArray[2] === 'Light') {
                ...
                allColors[propertiesArray[2]][propertiesArray[3]][parseInt(propertiesArray[4])] = thisColorHSLA;
            }
            if (propertiesArray[2] === 'jbkr') {
                ...
                allColors[propertiesArray[3]][propertiesArray[4]][parseInt(propertiesArray[5])] = thisColorHSLA;
            }
        });
