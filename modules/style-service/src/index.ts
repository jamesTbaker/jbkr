...
export const fontFilesImport = style.type.fontFilesImport;
export const fontPrimaryName = style.type.fontPrimaryName;
export const fontFallbacksNames = style.type.fontFallbacksNames;
